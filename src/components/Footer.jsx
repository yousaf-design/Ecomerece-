import { Link } from 'react-router-dom'; // Importing Link as a named export
import FOOTER_LINKS from '../assets/footer_links';
import FOOTER_CONTACT_INFO from '../assets/footer_contact'; // Keep this import as is
import SOCIALS from '../assets/socials'; // Change this to a different variable name
      ...
      <div className='max_padd_container flex w-full flex-col gap-14'>
        <div className='flex flex-col items-start justify-center gap-[10%] md:flex-row'>
          ...
          <div className='flex flex-wrap gap-8 sm:justify-between md:flex-1'>
            ...
            <div className='flex'>
              <FooterColumn title={SOCIALS.title}> {/* Use SOCIALS variable for social media links */}
